                    ...
                    <div class="container">
                        <div class="col-lg-9 main-chart">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        { 
                                                                ...
                                                                if( confirmation ) 
                                                                        { 
                                                                        window.location.href = "supprimerpub?id=<c:out  value='${data.id_Publication}'/>" ; 
                                                                        } 
                                                        } 
                                    </script>
                                    </div>
                            ...
                            <div class="tab-pane" id="add-comment">
                                <!--Form-->          <form action="publicationadm" method="post" class="form-horizontal" id="commentForm" role="form"> 
