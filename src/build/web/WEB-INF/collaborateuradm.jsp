            ...
            <header class="header black-bg" >
                ...
                <div class="nav notify-row" id="top_menu">
                    <ul class="nav top-menu">
                        <li id="header_inbox_bar" class="dropdown" style="margin-left:800px"> <a data-toggle="dropdown"> <i class="fa fa-envelope" ></i> <span class="badge bg-theme">5</span> </a>
                            <ul class="dropdown-menu extended inbox">
                                <div class="notify-arrow notify-arrow-green"></div>
                                <li>
                                    <p class="green">Tu as 5 nouveaux messages !</p>
                                </li>
                                <li> <a href="#">  <span class="subject"> <span class="from">Elaouani Saad</span> <span class="time">A l'instant</span> </span> <span class="message"> Ha ana salit lkhedma </span> </a> </li>
                                <li> <a href="#">  <span class="subject"> <span class="from">Kassimi Saad</span> <span class="time">40 mins.</span> </span> <span class="message"> kayn a mon chef </span> </a> </li>
                                <li> <a href="#">  <span class="subject"> <span class="from">Bellakbil Ibrahim</span> <span class="time">2 hrs.</span> </span> <span class="message"> sarout dyal chambre? </span> </a> </li>
                                <li> <a href="#">  <span class="subject"> <span class="from">Ferrak Anas</span> <span class="time">4 hrs.</span> </span> <span class="message"> tmchi la salle? </span> </a> </li>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="table" class="table-editable">
                                        <span class="table-add float-right mb-3 mr-2"><a href="tachecolabajouteradm" class="text-success"><i class="fa fa-plus fa-2x" aria-hidden="true"></i></a></span>
                                        <table class="table table-bordered table-responsive-md table-striped text-center">
                                            ...
                                            <tr><form method="post" action="tachecolabadm">
                                                <input id="input" type="hidden" name="action" value="modifier">
                                                <td class="pt-3-half" contenteditable="true"><input id="input" type="number" name="id" value="<c:out  value='${data.id_Projet}'/>"></td>
                                                ...
                                                <td>
                                                    ...
                                                    <script language="javascript"> 
                                                            ...
                                                            { 
                                                                    ...
                                                                    if( confirmation ) 
                                                                            { 
                                                                            window.location.href = "tachecolabsupprimeradm?id=<c:out  value='${data.id_Tache}'/>" ; 
                                                                            } 
                                                            } 
                                                    </script>
                                                </td>
