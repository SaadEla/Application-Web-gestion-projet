                        ...
                        <div class="col-lg-9 main-chart">
                            ...
                            <div class="container-contact100">
                                    <div class="wrap-contact100">
                                            ...
                                            <form class="contact100-form validate-form" method="post" action="tachecolabajouteradm">
                                                    <div class="wrap-input100 validate-input">
                                                            <span class="label-input100">Id Projet:</span>
                                                            <input class="input100" type="text" name="id">
                                                            <span class="focus-input100"></span>
                                                    </div>
                                                    <div class="wrap-input100 validate-input">
                                                            <span class="label-input100">Nom et Prenom:</span>
                                                            <input class="input100" type="text" name="Collaborateur">
                                                            <span class="focus-input100"></span>
                                                    </div>

                                                    <div class="wrap-input100 validate-input">
                                                            <span class="label-input100">Tache:</span>
                                                            <input class="input100" type="text" name="Tache" >
                                                            <span class="focus-input100"></span>
                                                    </div>
                                                
                                                    <div class="wrap-input100 validate-input">
                                                            <span class="label-input100">Date Debut Tache:</span>
                                                            <input class="input100" type="date" name="DateDebutTache" >
                                                            <span class="focus-input100"></span>
                                                    </div>
                                                    <div class="wrap-input100 validate-input">
                                                            <span class="label-input100">Date Fin Tache:</span>
                                                            <input class="input100" type="date" name="DateFinTache">
                                                            <span class="focus-input100"></span>
                                                    </div>
   ...
   <!--Afficher admin-->
                            ...
                            <div class="desc">
                                ...
                                <div class="details">
                                    ...
                                    <muted><c:out value="${administrateur.Disponibilite}"/></muted>
                                </div>
                                </c:forEach>
                            </div>
