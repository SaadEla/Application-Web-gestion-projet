        ...
        <section id="container" >
            ...
            <section id="main-content">
                ...
                <section class="wrapper">
                    <div class="row">
                        <sql:setDataSource var="bd" scope="request" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost:3306/gestiondeprojet?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC" user="root" password="" />
                        <sql:query var="resultat" dataSource="${bd}">select * from collaborateur where Email='<%= session.getAttribute("sessionUtilisateur")%>'</sql:query> 
                        <c:forEach items="${resultat.rows}" var="data">
                            <form action="profileco" method="post">
                                ...
                                <div class="col-sm-9 col-md-6 col-lg-8">
                                    ...
                                    <ul>
                                        <li> <i class="fa fa-address-book" style="font-size:30px"></i><span style="font-size:20px"><b>Nom et Prenom:</b>&nbsp;&nbsp;<input style="border:none;background-color:#F2F2F2;" type="text" name="NomPrenom" value="<c:out value="${data.NomPrenom}"/>"/></span></li>
                                    ...
                                    <center style="font-size: 20px;"><input style="border:none;background-color:#F2F2F2;" type="text" name="Competences" value="<c:out value="${data.Competences}"/>"/></center>
                                </div>
                            </form>
                        </c:forEach>  
                    </div>
