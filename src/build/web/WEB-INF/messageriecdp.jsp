    ...
    <body>
        ...
        <section id="container" >
            <header class="header black-bg" >
                ...
                <a href="accueilchedeprojet.jsp" class="logo" style="font-family: Times New Roman ,fantasy;font-size:200%;font-style: normal;font-weight: bolder; "><b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspSTRATON</b></a>
                ...
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-9 main-chart">
                            ...
                            <a href="envoyermessagecdp"><span ><button type="submit" class="btn btn-danger btn-rounded btn-sm my-0">Envoyer Message</button></span></a>
                            <sql:setDataSource var="bd" scope="request" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost:3306/gestiondeprojet?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC" user="root" password="" />
                            <sql:query var="resultat" dataSource="${bd}">SELECT * from message where destination="${sessionUtilisateur}"</sql:query>
                            <c:forEach items="${resultat.rows}" var="data">
                                <div class="panel panel-default">
                                    ...
                                    <script language="javascript"> 
                                        ...
                                        { 
                                                                ...
                                                                if( confirmation ) 
                                                                        { 
                                                                        window.location.href = "messageriecdp?source=<c:out  value='${data.Source}'/>" ; 
                                                                        } 
                                                        } 
                                    </script>
                                </div>
