                    ...
                    <ul class="nav top-menu">
                        <li id="header_inbox_bar" class="dropdown" style="margin-left:800px"> <a data-toggle="dropdown"> <i class="fa fa-envelope" ></i> <span class="badge bg-theme">1</span> </a>
                            <ul class="dropdown-menu extended inbox">
                                ...
                                <li> <a href="messageriecollab">  <span class="subject"> <span class="from">${data.Source}</span> <span class="time"></span> </span> <span class="message"> ${data.contenu}</span> </a> </li>
                                </c:forEach>
                                <li> <a href="messageriecollab">Voir tout.</a> </li>
                            </ul>
                        </li>
                    </ul>
                </div>
            ...
            <aside>
                <div id="sidebar"  class="nav-collapse ">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="mt"> <a  href="messageriecollab"> <i class="fa fa-commenting-o"></i> <span>Messagerie</span> </a> </li>
                    </ul>
                </div>
            </aside>
                    ...
                    <div class="container">
                        <div class="col-lg-9 main-chart">
                            ...
                            <div class="tab-pane" id="add-comment">
                                <!--Form-->          <form action="publication" method="post" class="form-horizontal" id="commentForm" role="form"> 
