                        ...
                        <div class="col-lg-9 main-chart">
                            ...
                            <div class="container-contact100">
                                    <div class="wrap-contact100">
                                            ...
                                            <form class="contact100-form validate-form" method="post" action="ajouter">
                                                    <div class="wrap-input100 validate-input">
                                                            <span class="label-input100">Nom du Projet:</span>
                                                            <input class="input100" type="text" name="NomProjet">
                                                            <span class="focus-input100"></span>
                                                    </div>

                                                    <div class="wrap-input100 validate-input" >
                                                            <span class="label-input100">Chef Du Projet:</span>
                                                            <input class="input100" type="text" name="ChefProjet">
                                                            <span class="focus-input100"></span>
                                                    </div>
