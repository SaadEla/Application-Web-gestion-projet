        ...
        <section id="container" >
            ...
            <section id="main-content">
                ...
                <section class="wrapper">
                    <div class="row">
                        <sql:setDataSource var="bd" scope="request" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost:3306/gestiondeprojet?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC" user="root" password="" />
                        <sql:query var="resultat" dataSource="${bd}">select * from administrateur where Email='<%= session.getAttribute("sessionUtilisateur")%>'</sql:query> 
                        <c:forEach items="${resultat.rows}" var="data">
                            <!--debut formulaire-->
                            <!--1er colonne-->
                            <form action="profile" method="post">
                                <div class="col-sm-3 col-md-6 col-lg-4">
                                    ...
                                    <p>Disponibilité:<b><input style="border:none;background-color:#F2F2F2;" type="text" name="Disponibilite" value="<c:out value='${data.Disponibilite}'/>"/></b></p>
                                    <button type="submit" class="btn btn-danger btn-rounded btn-sm my-0">Modifier</button>
                                </div></br>

                                <!--2eme colonne Administrateur-->
                                <div class="col-sm-9 col-md-6 col-lg-8">
                                    <center><h2>Informations Personnelles</h2></center>
                                    <ul>
                                        <li> <i class="fa fa-address-book" style="font-size:30px"></i><span style="font-size:20px"><b>Nom et Prenom:</b>&nbsp;&nbsp;<input style="border:none;background-color:#F2F2F2;" type="text" name="NomPrenom" value="<c:out value="${data.Nom}"/>&nbsp;<c:out value="${data.Prenom}"/>"/></span></li>
                                        <li><i class="fa fa-calendar" style="font-size:30px"></i><span style="font-size:20px"><b>Date de Naissance:</b>&nbsp;&nbsp;&nbsp;&nbsp;<input style="border:none;background-color:#F2F2F2;" type="text" name="DateNaissance" value="<c:out value="${data.DateNaissance}"/>"/></span></li>
                                        <li> <i  class="fa fa-home" style="font-size:30px"></i> <span style="font-size:20px"><b>Adresse:</b>&nbsp;&nbsp;<input style="border:none;background-color:#F2F2F2;" type="text" name="Adresse" value="<c:out value="${data.Adresse}"/>"/></span> </li>
                                        <li> <i  class="fa fa-phone" style="font-size:30px"></i> <span style="font-size:20px"><b>Telephone:</b>&nbsp;&nbsp;<input style="border:none;background-color:#F2F2F2;" type="text" name="Telephone" value="<c:out value="${data.Telephone}"/>"/></span> </li>
                                        <li> <i class="fa fa-envelope" style="font-size:30px"></i> <span style="font-size:20px"><b>Email:</b>&nbsp;&nbsp;<input style="border:none;background-color:#F2F2F2;" type="email" name="Email" value="<c:out value="${data.Email}"/>"/></span> </li>
                                    </ul>
                                    <center><h2>Formation</h2></center>
                                    <span style="font-size: 25px;">Dernier Diplome:</span>
                                    <ul>
                                        <li style="font-size: 20px;"><b style="width: 50px;"><u>Intitulé:</u></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input style="border:none;background-color:#F2F2F2;" type="text" name="Diplome" value="<c:out value="${data.Diplome}"/>"/></li>
                                        <li style="font-size: 20px;"><b><u>Année d'obtention:</u></b>&nbsp;&nbsp;&nbsp;&nbsp;<input style="border:none;background-color:#F2F2F2;" type="text" name="AnneeObtention" value="<c:out value="${data.AnneeObtention}"/>"/></li>
                                        <li style="font-size: 20px;"><b><u>Etablissement:</u></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input style="border:none;background-color:#F2F2F2;" type="text" name="Etablissement" value="<c:out value="${data.Etablissement}"/>"/></li>
                                    </ul>
                                    <center><h2>Competences</h2></center>
                                    <center style="font-size: 20px;"><input style="border:none;background-color:#F2F2F2;" type="text" name="Competence" value="<c:out value="${data.Competence}"/>"/></center>
                                </div>  
                            </form>
                        </c:forEach>   
                    </div>
