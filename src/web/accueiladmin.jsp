                ...
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-9 main-chart">
                            <h3 align="center" action="Connexion"><i>Bienvenue ${sessionUtilisateur} dans STRATON, une application dédiée a la gestion de vos projets.</i></h3>
                            <h4 align="center"><i><b>Nous espérons que vous avez reçu la conférence habituelle du système local Administrateur. Cela se résume généralement à ces trois choses:</b></i></h4>
                            <h5 align="center"><i><b>#1/Respectez la vie privée des autres.</b></i></h5>
                            <h5 align="center"><i><b>#2/Réfléchissez avant de taper.</b></i></h5>
                            <h5 align="center"><i><b>#3/Un grand pouvoir implique de grandes responsabilités.</b></i></h5><br/>
                            <div class="card">
                                        ...
                                        <table class="table table-bordered table-responsive-md table-striped text-center">
                                            ...
                                            <c:forEach items="${resultat.rows}" var="data">
                                                <tr>
                                                    ...
                                                    <td class="pt-3-half"><c:out  value="${data.ChefDeProjet}"/></td>
                                                </tr>
                                            </c:forEach>
