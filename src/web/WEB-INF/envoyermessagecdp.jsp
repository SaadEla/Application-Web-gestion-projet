    ...
    <body>
        ...
        <section id="container" >
            <header class="header black-bg" >
                ...
                <a href="accueilachefdeprojet.jsp" class="logo" style="font-family: Times New Roman ,fantasy;font-size:200%;font-style: normal;font-weight: bolder; "><b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspSTRATON</b></a>
                        ...
                        <div class="col-lg-9 main-chart">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form action="envoyermessagecdp" method="post">
