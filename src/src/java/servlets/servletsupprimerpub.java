...
public class servletsupprimerpub extends HttpServlet {
    public static final String VU              = "/WEB-INF/actualiteadm.jsp";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
    	    ...
    	    String query="delete from publication where id_Publication='"+id+"'";
