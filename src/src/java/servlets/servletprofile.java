...
public class servletprofile extends HttpServlet {
    public static final String VU              = "/WEB-INF/profile.jsp";
    public static final String VUE              = "profile";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
    	    ...
    	    String query="Update administrateur set Disponibilite='"+disponibilite+"',Email='"+email+"',DateNaissance='"+datenaissance+"',Adresse='"+adresse+"',Telephone='"+tel+"',Diplome='"+diplome+"',AnneeObtention='"+AnneeObtention+"',Competence='"+competence+"',Etablissement='"+etablissement+"' where Email='"+ident+"'";
