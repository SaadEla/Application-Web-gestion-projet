...
public class servletsupprimermessagecp extends HttpServlet {
    public static final String VU              = "/WEB-INF/messageriecdp.jsp";
    public static final String VUE              = "messageriecdp";
