...
public class servletajouterpubcdp extends HttpServlet {
    public static final String VU              = "/WEB-INF/actualitecdp.jsp";
    public static final String VUE              = "publicationcdp";
