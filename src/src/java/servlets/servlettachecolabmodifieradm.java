...
public class servlettachecolabmodifieradm extends HttpServlet {
    public static final String VU              = "/WEB-INF/collaborateuradm.jsp";
    public static final String VUE              = "tachecolabadm";
