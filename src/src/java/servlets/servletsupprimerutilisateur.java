...
public class servletsupprimerutilisateur extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String form=request.getParameter("fonction");
            if(form.equals("formChef")){
                String query="delete from chefdeprojet where id_ChefDeProjet='"+id+"'";
                statement.executeUpdate(query);
            }
            if(form.equals("formColl")){
                String query1="delete from collaborateur where id_Collaborateur='"+id+"'";
