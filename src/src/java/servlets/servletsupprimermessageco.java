...
public class servletsupprimermessageco extends HttpServlet {
    public static final String VU              = "/WEB-INF/messagerieco.jsp";
    public static final String VUE              = "messagerieco";
