...
public class servletenvoyermessageco extends HttpServlet {
        public static final String VU              = "/WEB-INF/envoyermessageco.jsp";
    public static final String VUE              = "envoyermessageco";
