...
public class servlettachecolabajouteradm extends HttpServlet {
    public static final String VU              = "/WEB-INF/ajoutercollabadm.jsp";
    public static final String VUE              = "tachecolabajouteradm";
